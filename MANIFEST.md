...
| `fable` | Fable 整合のエージェント推論。主骨: [Anthropic System Prompts — Fable 5](https://platform.claude.com/docs/en/release-notes/system-prompts) の認識論・自己確認。補助: [shotatykr の挙動トレース](https://x.com/shotatykr/status/2074035238116769851)（Phase 0–4・模倣手順。公式未記載分のみ）。併用: `agent-handoff-recovery` / `ralph-loop` |
