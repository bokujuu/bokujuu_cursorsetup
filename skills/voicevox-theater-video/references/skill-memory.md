...
- 2026/08/01 (Sol xhigh): 縁の矩形化＝余白なし alpha への MaxFilter＋NEAREST 拡大が主因。`$J$` 巨大化＝mathtext 高 dpi を字幕 48px に合わせず並べたこと。対策は単純記号の同一フォント flatten＋`build_outline_masks` 復帰、複雑式のみ高さ合わせ＋`outer_w+8` 余白。
