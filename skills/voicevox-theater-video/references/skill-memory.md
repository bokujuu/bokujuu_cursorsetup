...
- 2026/08/02 08:05 (A/B実測): 同一 s01–s08+outro。legacy≈99.2s vs new(合成のみ)≈95.1s（×1.04）。new+CFR≈109.7s で総時間は劣後。outro/CFR/短クリップNVENCが支配。速度を主目的にするなら CFR 任意化と outro 最適化が先。
