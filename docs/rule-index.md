...
| **VOICEVOX 劇場レイアウト動画（立ち絵＋ワイプ字幕）** | skill `voicevox-theater-video` → 親 `slide-narration-video`（dialogue）。立ち絵・口パク（実音＋0.2s遅れ）・弾む登場・字幕3パス縁取り |
...
| `voicevox-theater-video` | VOICEVOX 劇場拡張（立ち絵・ワイプ字幕・実音口パク・弾む登場）。親: `slide-narration-video` |
